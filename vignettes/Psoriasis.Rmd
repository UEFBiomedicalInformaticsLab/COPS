...
<code>COPS</code> does not provide tools for processing sequencing data or 
performing batch-correction and therefore we expect that the input data has 
already been pre-processed appropriately. For example, RNA-Seq counts should be 
normalized and variance stabilised, i.e. log-scaled TPM or CPM and DNA-methylation 
should be given as methylation percentages or M-values. 
