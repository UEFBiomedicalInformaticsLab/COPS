...
\itemize{
  \item Knowledge-driven feature extraction: GSVA, DiffRank, RWR-FGSEA
  \item Dimensional reduction: PCA, t-SNE, UMAP
  \item Single-omics clustering algorithms: k-means++, agglomerative hierarchical clustering, DIANA, Gaussian Mixture Models (GMMs), kernel k-means, knn graph community detection
}
