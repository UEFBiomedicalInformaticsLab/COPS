...
res_diffrank_otp <- COPS::dimred_clusteval_pipeline(list(expr = tbrca_norm[brca_degs,]),
...
write.csv(scores_diffrank_otp$all, paste0(path_intermediate_results, "/brca/diffrank_deg/scores.csv"))
write.csv(res_diffrank_otp$clusters, gzfile(paste0(path_intermediate_results, "/brca/diffrank_deg/clusters.csv.gz")))
