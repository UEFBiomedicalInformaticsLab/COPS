...
# UMAP 10 neighbours
res_dimred_otp <- COPS::dimred_clusteval_pipeline(list(expr = log2(tprad_norm[prad_degs,] + 1)), 
...
write.csv(scores_dimred_otp$all, paste0(path_intermediate_results, "/prad/dimred_deg/scores.csv"))
write.csv(res_dimred_otp$clusters, gzfile(paste0(path_intermediate_results, "/prad/dimred_deg/clusters.csv.gz")))