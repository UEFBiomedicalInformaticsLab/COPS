...
res_gsva_otp <- COPS::dimred_clusteval_pipeline(list(expr = log2(tprad_norm[prad_degs,]+1)),
...
write.csv(scores_gsva_otp$all, paste0(path_intermediate_results, "/prad/gsva_deg/scores.csv"))
write.csv(res_gsva_otp$clusters, gzfile(paste0(path_intermediate_results, "/prad/gsva_deg/clusters.csv.gz")))
