...
# UMAP 10 neighbours
res_dimred_otp <- COPS::dimred_clusteval_pipeline(list(expr = log2(tbrca_norm[brca_degs,] + 1)), 
...
write.csv(scores_dimred_otp$all, paste0(path_intermediate_results, "/brca/dimred_deg/scores.csv"))
write.csv(res_dimred_otp$clusters, gzfile(paste0(path_intermediate_results, "/brca/dimred_deg/clusters.csv.gz")))