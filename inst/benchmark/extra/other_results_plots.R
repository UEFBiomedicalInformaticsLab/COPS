...
ggplot(brca_res_knn_comm[brca_res_knn_comm$fold != 6,], aes(x = k, y = Silhouette, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_knn_comm[brca_res_knn_comm$fold != 6,], aes(x = k, y = TrainStabilityJaccard, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_knn_comm[brca_res_knn_comm$fold != 6,], aes(x = k, y = cNMI, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_knn_comm[brca_res_knn_comm$fold != 6,], aes(x = k, y = Module_score, fill = m)) + geom_boxplot() + theme_bw()
...
ggplot(brca_res_sc3[brca_res_sc3$fold != 6,], aes(x = k, y = Silhouette, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_sc3[brca_res_sc3$fold != 6,], aes(x = k, y = TrainStabilityJaccard, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_sc3[brca_res_sc3$fold != 6,], aes(x = k, y = cNMI, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_sc3[brca_res_sc3$fold != 6,], aes(x = k, y = Module_score, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(brca_res_sc3[brca_res_sc3$fold != 6,], aes(x = k, y = SurvivalPValue, group = k, fill = m)) + geom_boxplot() + theme_bw() +
  scale_y_continuous(trans = scales::trans_new("reverse_log", function(x) -log(x), function(y) exp(-y), breaks = scales::log_breaks()), 
                     limits = c(1.0, 5e-8)) + 
  ggtitle("Survival p-value of direct clustering methods in BRCA")
...
ggplot(prad_res_spectral[prad_res_spectral$fold != 6,], aes(x = k, y = Silhouette, group = k, fill = m)) + geom_boxplot()
ggplot(prad_res_spectral[prad_res_spectral$fold != 6,], aes(x = k, y = TrainStabilityJaccard, group = k, fill = m)) + geom_boxplot()
ggplot(prad_res_spectral[prad_res_spectral$fold != 6,], aes(x = k, y = cNMI, group = k, fill = m)) + geom_boxplot()
ggplot(prad_res_spectral[prad_res_spectral$fold != 6,], aes(x = k, y = Module_score, group = k, fill = m)) + geom_boxplot()
ggplot(prad_res_spectral[prad_res_spectral$fold != 6,], aes(x = k, y = SurvivalPValue, group = k, fill = m)) + geom_boxplot() + theme_bw() +
  scale_y_continuous(trans = scales::trans_new("reverse_log", function(x) -log(x), function(y) exp(-y), breaks = scales::log_breaks()), 
                     limits = c(1.0, 5e-4)) + 
  ggtitle("Survival p-value of direct clustering methods in PRAD")
...
ggplot(prad_res_sc3[prad_res_sc3$fold != 6,], aes(x = k, y = Silhouette, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(prad_res_sc3[prad_res_sc3$fold != 6,], aes(x = k, y = TrainStabilityJaccard, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(prad_res_sc3[prad_res_sc3$fold != 6,], aes(x = k, y = cNMI, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(prad_res_sc3[prad_res_sc3$fold != 6,], aes(x = k, y = Module_score, group = k, fill = m)) + geom_boxplot() + theme_bw()
ggplot(prad_res_sc3[prad_res_sc3$fold != 6,], aes(x = k, y = SurvivalPValue, group = k, fill = m)) + geom_boxplot() + theme_bw() +
  scale_y_continuous(trans = scales::trans_new("reverse_log", function(x) -log(x), function(y) exp(-y), breaks = scales::log_breaks()), 
                     limits = c(1.0, 5e-4)) + 
  ggtitle("Survival p-value of direct clustering methods in prad")
