...
res_gsva_otp <- COPS::dimred_clusteval_pipeline(list(expr = log2(tbrca_norm[brca_degs,]+1)),
...
write.csv(scores_gsva_otp$all, paste0(path_intermediate_results, "/brca/gsva_deg/scores.csv"))
write.csv(res_gsva_otp$clusters, gzfile(paste0(path_intermediate_results, "/brca/gsva_deg/clusters.csv.gz")))
