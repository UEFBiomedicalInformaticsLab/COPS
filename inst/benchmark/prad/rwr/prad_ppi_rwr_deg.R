...
write.csv(as.matrix(rwr.up), gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/rwr.up.csv.gz")))
write.csv(as.matrix(rwr.down), gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/rwr.down.csv.gz")))
...
write.csv(out$KEGG, gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/KEGG.csv.gz")))
write.csv(out$GO, gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/GO.csv.gz")))
write.csv(out$REACTOME, gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/REACTOME.csv.gz")))
write.csv(out$HALLMARK, gzfile(paste0(path_intermediate_results, "/prad/rwr/ppi_rwr_deg/HALLMARK.csv.gz")))