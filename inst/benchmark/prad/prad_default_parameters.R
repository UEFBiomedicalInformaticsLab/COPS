...
RWR_GCN_THRESHOLD <- 0.525

# Gene modules
MODULE_POWER <- 4

# Survival analysis
#SURVIVAL_COVARIATES <- c("patient.clinical_cqcf.psa_result_preop", "years_to_birth")
SURVIVAL_COVARIATES <- c("patient.clinical_cqcf.psa_result_preop", "pathology_N_stage")
