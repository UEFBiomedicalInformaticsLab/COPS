...
res_pca <- COPS::dimred_clusteval_pipeline(list(expr = log2(tprad_norm[-zero_var,] + 1)), 
...
write.csv(res_pca$clusters, gzfile(paste0(path_intermediate_results, "/prad/dimred/dimred_pca/clusters.csv.gz")))
