...
write.csv(scores_diffrank_otp$all, paste0(path_intermediate_results, "/prad/diffrank_otp/scores.csv"))
write.csv(res_diffrank_otp$clusters, gzfile(paste0(path_intermediate_results, "/prad/diffrank_otp/clusters.csv.gz")))
