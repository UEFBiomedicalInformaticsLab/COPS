...
res_tsne <- COPS::dimred_clusteval_pipeline(list(expr = log2(tbrca_norm[-zero_var,] + 1)), 
...
write.csv(res_tsne$clusters, gzfile(paste0(path_intermediate_results, "/brca/dimred/dimred_tsne/clusters.csv.gz")))
