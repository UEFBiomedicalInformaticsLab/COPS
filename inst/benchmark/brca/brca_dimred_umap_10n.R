...
res_umap10 <- COPS::dimred_clusteval_pipeline(list(expr = log2(tbrca_norm[-zero_var,] + 1)), 
...
write.csv(res_umap10$clusters, gzfile(paste0(path_intermediate_results, "/brca/dimred/dimred_umap_10n/clusters.csv.gz")))
